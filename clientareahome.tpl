...
{foreach from=$addons_html item=addon_html}
    <div>
        ...
        <div>
            <div class="promo-banner promo-banner-rounded symantec-ssl symantec-upsell-ssl">
                <div class="panel-body">
                    <div class="icon-left">
                        <a href="/hospedagem/index.php?rp=/store/ssl-certificates">
                            <img src="/hospedagem/assets/img/marketconnect/symantec/ssl.png">
                        </a>
                    </div>

                    <div class="content">
                        <h3>
                            Proteja seu site e aumente seu ranking em sites de busca com um certificado SSL
                            <small><a href="/hospedagem/index.php?rp=/store/ssl-certificates">Saiba mais...</a></small>
                        </h3>
                        <h4>Incluso com o certificado</h4>
                        <ul>
                            <li><i class="fa fa-check-circle-o"></i> Criptografia de dados de 256-bits</li>
                            <li><i class="fa fa-check-circle-o"></i> Reemissões ilimitadas</li>
                            <li><i class="fa fa-check-circle-o"></i> Compatível com navegadores modernos</li>
                            <li><i class="fa fa-check-circle-o"></i> Selo de segurança</li>
                        </ul>

                        <form method="post" action="/hospedagem/index.php?rp=/store/order">
                            <input type="hidden" name="token" value="3ca52f5e0931bcba81537062ab47832c016e08cc">
                            <input type="hidden" name="pid" value="6">
                            <button type="submit" class="btn btn-success">
                               Adicionar RapidSSL por R$80,00 por ano
                            </button>
                        </form>
